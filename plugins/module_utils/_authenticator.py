...
from plugins.module_utils._auth_method_azure_ad import AkeylessAuthMethodAzureAd

from plugins.module_utils._auth_method_cert import AkeylessAuthMethodCert
from plugins.module_utils._auth_method_gcp import AkeylessAuthMethodGcp
from plugins.module_utils._auth_method_jwt import AkeylessAuthMethodJwt
from plugins.module_utils._auth_method_k8s import AkeylessAuthMethodK8s
from plugins.module_utils._auth_method_ldap import AkeylessAuthMethodLdap
from plugins.module_utils._auth_method_oci import AkeylessAuthMethodOci
from plugins.module_utils._auth_method_oidc import AkeylessAuthMethodOidc
from plugins.module_utils._auth_method_password import AkeylessAuthMethodPassword
from plugins.module_utils._auth_method_saml import AkeylessAuthMethodSaml
from plugins.module_utils._auth_method_universal_identity import AkeylessAuthMethodUniversalIdentity
